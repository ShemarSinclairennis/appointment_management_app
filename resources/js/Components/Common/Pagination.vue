        ...
        <div class="flex space-x-1 items-top" v-if="pagination.last_page > 1">
            ...
            >
                <!-- <input
                    ...
                    v-model="page"
                    class="px-6 w-11 h-11 text-center rounded border border-gray-400 shadow-sm lg:h-9 lg:w-9 lg:text-sm focus:ring-blue-500 focus:border-blue-500"
                /> -->
                <div class="text-gray-600 lg:text-sm">
